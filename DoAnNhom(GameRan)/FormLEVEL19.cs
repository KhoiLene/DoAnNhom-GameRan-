...
{
    public partial class FormLEVEL19 : Form
    {
        ...
        public FormLEVEL19(int userId)
        {
            ...
            int userHS = db.GetUserHighScore(currentUserId, "Level19");
            highScore = userHS;
            ...
            int serverHS = db.GetServerHighScore("Level19");
        ...
        {
            string level = "Level19"; // hoặc biến level hiện tại
        ...
        private void GameOver()
        {
            ...
            db.SaveScore(currentUserId, "Level19", score);
