...
{
    public partial class FormLEVEL9 : Form
    {
        ...
        public FormLEVEL9(int userId)
        {
            ...
            int userHS = db.GetUserHighScore(currentUserId, "Level9");
            highScore = userHS;
            ...
            int serverHS = db.GetServerHighScore("Level9");
        ...
        {
            string level = "Level9"; // hoặc biến level hiện tại
        ...
        private void GameOver()
        {
            ...
            db.SaveScore(currentUserId, "Level9", score);
