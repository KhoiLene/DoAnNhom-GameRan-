...
{
    public partial class FormLEVEL17 : Form
    {
        ...
        public FormLEVEL17(int userId)
        {
            ...
            int userHS = db.GetUserHighScore(currentUserId, "Level17");
            highScore = userHS;
            ...
            int serverHS = db.GetServerHighScore("Level17");
        ...
        {
            string level = "Level17"; // hoặc biến level hiện tại
        ...
        private void GameOver()
        {
            ...
            db.SaveScore(currentUserId, "Level17", score);
