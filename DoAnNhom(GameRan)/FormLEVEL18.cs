...
{
    public partial class FormLEVEL18 : Form
    {
        ...
        public FormLEVEL18(int userId)
        {
            ...
            int userHS = db.GetUserHighScore(currentUserId, "Level18");
            highScore = userHS;
            ...
            int serverHS = db.GetServerHighScore("Level18");
        ...
        {
            string level = "Level18"; // hoặc biến level hiện tại
        ...
        private void GameOver()
        {
            ...
            db.SaveScore(currentUserId, "Level18", score);
