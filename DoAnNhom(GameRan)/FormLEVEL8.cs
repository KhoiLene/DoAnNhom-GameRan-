...
{
    public partial class FormLEVEL8 : Form
    {
        ...
        public FormLEVEL8(int userId)
        {
            ...
            int userHS = db.GetUserHighScore(currentUserId, "Level8");
            highScore = userHS;
            ...
            int serverHS = db.GetServerHighScore("Level8");
        ...
        {
            string level = "Level8"; // hoặc biến level hiện tại
        ...
        private void GameOver()
        {
            ...
            db.SaveScore(currentUserId, "Level8", score);
