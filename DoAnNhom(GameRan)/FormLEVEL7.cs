...
{
    public partial class FormLEVEL7 : Form
    {
        ...
        public FormLEVEL7(int userId)
        {
            ...
            int userHS = db.GetUserHighScore(currentUserId, "Level7");
            highScore = userHS;
            ...
            int serverHS = db.GetServerHighScore("Level7");
        ...
        {
            string level = "Level7"; // hoặc biến level hiện tại
        ...
        private void GameOver()
        {
            ...
            db.SaveScore(currentUserId, "Level7", score);
