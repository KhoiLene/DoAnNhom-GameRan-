...
{
    public partial class FormLEVEL15 : Form
    {
        ...
        public FormLEVEL15(int userId)
        {
            ...
            int userHS = db.GetUserHighScore(currentUserId, "Level15");
            highScore = userHS;
            ...
            int serverHS = db.GetServerHighScore("Level15");
        ...
        {
            string level = "Level15"; // hoặc biến level hiện tại
        ...
        private void GameOver()
        {
            ...
            db.SaveScore(currentUserId, "Level15", score);
