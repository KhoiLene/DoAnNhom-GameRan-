...
{
    public partial class FormLEVEL13 : Form
    {
        ...
        public FormLEVEL13(int userId)
        {
            ...
            int userHS = db.GetUserHighScore(currentUserId, "Level13");
            highScore = userHS;
            ...
            int serverHS = db.GetServerHighScore("Level13");
        ...
        {
            string level = "Level13"; // hoặc biến level hiện tại
        ...
        private void GameOver()
        {
            ...
            db.SaveScore(currentUserId, "Level13", score);
