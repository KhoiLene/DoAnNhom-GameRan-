...
{
    public partial class FormLEVEL11 : Form
    {
        ...
        public FormLEVEL11(int userId)
        {
            ...
            int userHS = db.GetUserHighScore(currentUserId, "Level11");
            highScore = userHS;
            ...
            int serverHS = db.GetServerHighScore("Level11");
        ...
        {
            string level = "Level11"; // hoặc biến level hiện tại
        ...
        private void GameOver()
        {
            ...
            db.SaveScore(currentUserId, "Level11", score);
