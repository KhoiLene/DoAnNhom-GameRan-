...
{
    public partial class FormLEVEL14 : Form
    {
        ...
        public FormLEVEL14(int userId)
        {
            ...
            int userHS = db.GetUserHighScore(currentUserId, "Level14");
            highScore = userHS;
            ...
            int serverHS = db.GetServerHighScore("Level14");
        ...
        {
            string level = "Level14"; // hoặc biến level hiện tại
        ...
        private void GameOver()
        {
            ...
            db.SaveScore(currentUserId, "Level14", score);
