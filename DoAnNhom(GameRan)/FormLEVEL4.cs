...
namespace DoAnNhom_GameRan_
{
    public partial class FormLEVEL4 : Form
    {
        ...
        public FormLEVEL4(int userId)
        {
            ...
            int userHS = db.GetUserHighScore(currentUserId, "Level4");
            highScore = userHS;
            ...
            int serverHS = db.GetServerHighScore("Level4");
        ...
        {
            string level = "Level4"; // hoặc biến level hiện tại
        ...
        private void GameOver()
        {
            ...
            db.SaveScore(currentUserId, "Level4", score);
