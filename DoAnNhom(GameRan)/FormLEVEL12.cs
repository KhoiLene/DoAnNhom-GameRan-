...
{
    public partial class FormLEVEL12 : Form
    {
        ...
        public FormLEVEL12(int userId)
        {
            ...
            int userHS = db.GetUserHighScore(currentUserId, "Level12");
            highScore = userHS;
            ...
            int serverHS = db.GetServerHighScore("Level12");
        ...
        {
            string level = "Level12"; // hoặc biến level hiện tại
        ...
        private void GameOver()
        {
            ...
            db.SaveScore(currentUserId, "Level12", score);
